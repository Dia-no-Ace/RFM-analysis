...
1. предобработка данных для дальнейшего анализа
2. выбор метрик для анализа
3. определение границ сегментов (разбиение выборки на перцентили)
4. выявление самых крупных групп клиентов и выработка маркетинговой стратегии для каждой из них.
